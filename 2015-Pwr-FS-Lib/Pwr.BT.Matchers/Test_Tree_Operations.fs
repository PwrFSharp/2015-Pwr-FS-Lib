namespace Pwr.BT.Test
    ...
    open Pwr.BT.Collections.Tree.Oper
...
//      let _reachedVal = postOrderTree inTree
//    
//      let _reachedLogic =  _expectedVal = _reachedVal
//    
//      Assert.True(_reachedLogic)
...
//
//    [<Test>]
//    let TreeAlgo_PostfixTreeToListCOnverterOwn2() =
//      let inTree = Empty
//        
//      let _expectedVal = []
//      let _reachedVal = postOrderTree inTree
...
//
//    [<Test>]
//    let TreeAlgo_PostfixTreeToListCOnverterOwn3() =
//      let inTree = Node(1,Empty,Empty)
//        
//      let _expectedVal = [1]
//      let _reachedVal = postOrderTree inTree
//    
